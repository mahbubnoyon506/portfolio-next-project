...
const Projects = () => {
    ...
    return (
        <div id='project' className='bg-primary p-5 md:p-10 lg:p-20 z-50'>
            <div className='flex justify-between pb-5'>
                <h2 className='text-3xl md:text-4xl lg:text-5xl font-semibold pb-5'>Recent Projects</h2>
                <div className='flex justify-between'>
                    <div onClick={handlePrev} className='border-2 w-10 h-10 rounded-full cursor-pointer flex justify-center items-center hover:bg-neutral hover:transition-all ease-in-out hover:duration-300 hover:border-neutral mr-2'>
                        <FaAngleDoubleLeft />
                    </div>
                    <div onClick={handleNext} className='border-2 w-10 h-10 rounded-full cursor-pointer flex justify-center items-center hover:bg-neutral hover:transition-all ease-in-out hover:duration-300 hover:border-neutral'>
                        <FaAngleDoubleRight />
                    </div>
                </div>
            </div>
